...
<img src="assets/demo.gif" alt="PayBridge: one execution running step by step, a step failing on purpose — held and escalated, in red — then that same step handled and the run completing" width="100%">

<p align="center">38 nodes · <b>6 failure paths, every one alerted</b> · append-only ledger · safe to re-run</p>
...
<img src="assets/output.png" alt="PayBridge: sample of the output a client receives, including one step that failed and what happened instead" width="100%">
